...
WebUI.setText(findTestObject('COMPUTERS_OR/INTRODUCED-DATE'), '2024-07-01')

WebUI.setMaskedText(findTestObject('COMPUTERS_OR/DISCONTINUED-DATE'), '2026-07-01')

WebUI.selectOptionByIndex(findTestObject('COMPUTERS_OR/COMPANY_DROPDOWN'), 8)
