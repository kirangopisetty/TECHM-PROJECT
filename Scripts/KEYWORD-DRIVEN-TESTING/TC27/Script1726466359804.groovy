...
if (rightPage == true) {
    WebUI.setText(findTestObject('COMPUTERS_OR/COMPUTER-NAME-TEXTBOX'), compName)
    ...
    WebUI.selectOptionByIndex(findTestObject('COMPUTERS_OR/COMPANY_DROPDOWN'), companyIndex)
